      ...
      <h4 class="text-center">Create a New Account</h4>
        ...
        <div class="form-group">
           <label for="email">Name</label>
               <input type="text" class="form-control" placeholder="Enter Your Full Name" name="name" value="<?php echo $set_name;?>">
               <p class="err-msg">
        ...
        <div class="form-group">
           <label for="email">Emergency Contact Name</label>
               <input type="text" class="form-control" placeholder="Enter emergency Contact Name" name="emergency_contact_name" value="<?php echo $set_emergencycontactname;?>">
               <p class="err-msg">
                <?php if($nameErr!=1){ echo $nameErr; }?>
                </p>
        </div>
        <div class="form-group">
            <label for="email">Emergency Contact Number</label>
                <input type="text" class="form-control" placeholder="Enter emergency contact number" name="emergency_contact_number" value="<?php echo $set_emergencycontactnumber;?>">
                <p class="err-msg">
                    <?php if($contactErr!=1){ echo $contactErr; } ?>
                </p>
        </div>
